 ...
 return (
   <main className="homepage">
     <section
       ...
       style={{
         backgroundImage: `linear-gradient(180deg, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.4)), url(${heroImage})`,
       }}
     >
       <div className="hero-inner">
         ...
         <a href="#calculators" className="scroll-arrow" aria-label="Scroll to calculators">
